  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected:
          "bg-primary-100 text-primary-foreground hover:!bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
        today:
          "border border-solid border-secondary-600  bg-accent text-accent-foreground",
        outside:
